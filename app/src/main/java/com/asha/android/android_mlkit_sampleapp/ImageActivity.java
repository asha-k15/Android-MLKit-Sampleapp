        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                ...
                case RC_SELECT_PICTURE:
                    ...
                    if (path == null) {
                        mBitmap = AppHelper.resizeImage(imageFile, this, dataUri, mImageView);
                    } else {
                        mBitmap = AppHelper.resizeImage(imageFile, path, mImageView);
                    }
                    if (mBitmap != null) {
                        mTextView.setText(null);
                ...
                case RC_TAKE_PICTURE:
                    mBitmap = AppHelper.resizeImage(imageFile, imageFile.getPath(), mImageView);
                    if (mBitmap != null) {
                        mTextView.setText(null);
                        mImageView.setImageBitmap(mBitmap);
                    }
